...
#'
#' \code{coefficients} The estimated coefficients \eqn{\nu}.
#' \code{sol.path} Solution path for \eqn{\nu} across iterations.
#' \code{cov.hat} Estimated covariance matrix for \eqn{\nu}.
#' \code{se} Standard errors of the estimated coefficients.
#' \code{lower} Lower bound of the 95% confidence interval for \eqn{\nu}.
#' \code{upper} Upper bound of the 95% confidence interval for \eqn{\nu}.
