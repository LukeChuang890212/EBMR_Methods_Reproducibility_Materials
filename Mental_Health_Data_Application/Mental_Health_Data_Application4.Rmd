...
```{r}
bootstrap = function(ps_specifications, data, B, is.perturb = FALSE){
  library(foreach)
  library(doParallel)
  library(doSNOW)
  library(EBMRalgorithm)
...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    for(k in 1:2) {
      ...
      boot_result = bootstrap(ps_specifications, subdat, B, is.perturb = TRUE)
