...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    # boot_result = perturb_bootstrap(ps_specifications, W, subdat, result$mu_ipw, B)
    boot_result = bootstrap(ps_specifications, W, dat, B)
    save.file = paste0(c("MHD_results/EBMR_IPW_bootstrap_", model_set, "_OR7.RDS"), collapse = "")
    if(file.exists(save.file)){
      boot_result = cbind(readRDS(save.file), boot_result)
      saveRDS(boot_result, save.file)
    }else{
...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    # boot_result = perturb_bootstrap(ps_specifications, W, subdat, result$mu_ipw, B)
    boot_result = bootstrap(ps_specifications, W, dat, B)
    save.file = paste0(c("MHD_results/EBMR_IPW_bootstrap_", model_set, "_OR8.RDS"), collapse = "")
    # if(file.exists(save.file)){
    #   boot_result = cbind(readRDS(save.file), boot_result)
    #   saveRDS(boot_result, save.file)
    # }else{
...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    for(k in 1:2) {
      ...
      read_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", model_set, "_OR4.RDS"), collapse = "")
      result = readRDS(read_file)
      ...
      # boot_result = perturb_bootstrap(ps_specifications, W, subdat, result$mu_ipw, B)
      boot_result = bootstrap(ps_specifications, W, subdat, B)
