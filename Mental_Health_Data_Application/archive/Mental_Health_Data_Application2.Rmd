      ...
      for(model_num in 1:3){
        ...
        for(i in 1:ncol(model_combinations)){
          ...
          for(l in 1:2){
            ...
            ebmr = EBMRAlgorithmOld$new("teacher_report", ps_specifications, sub_boot_dat, W)
...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    for(k in 1:length(health)){
      ...
      ebmr = EBMRAlgorithmOld$new("teacher_report", ps_specifications, subdat, W)
      result = ebmr$EBMR_IPW(h_x_names = c("father", "parent_report"),
                             true_ps =  NULL)

      # save_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", model_set, "_W_optimal_OR8.RDS"), collapse = "")
      save_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", model_set, "_W_optimal_OR10.RDS"), collapse = "")
...
save.file = paste0(c("MHD_results/EBMR_IPW_bootstrap_W_optimal_OR11.RDS"), collapse = "")
...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    result0 = readRDS(paste0(c("MHD_results/EBMR_IPW_", subset_names[1], "_", model_set, "_W_optimal_OR10.RDS"), collapse = ""))
    all_estimates[1, ] = unlist(result0[c(1, 3)])

    result1 = readRDS(paste0(c("MHD_results/EBMR_IPW_", subset_names[2], "_", model_set, "_W_optimal_OR10.RDS"), collapse = ""))
...
boot_result = readRDS(paste0(c("MHD_results/EBMR_IPW_bootstrap_W_optimal_OR10.RDS"), collapse = ""))
...
for(k in 1:2){
  ...
  for(xi in xi.vector){
    ...
    save_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", 1:3, "_mild", round(xi, 3), "_OR8.RDS"), collapse = "")
