...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    for(k in 1:length(health)){
      ...
      save_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", model_set, "_W_optimal_OR7.RDS"), collapse = "")
...
save.file = paste0(c("MHD_results/EBMR_IPW_bootstrap_W_optimal_OR7.RDS"), collapse = "")
...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    result0 = readRDS(paste0(c("MHD_results/EBMR_IPW_", subset_names[1], "_", model_set, "_W_optimal_OR7.RDS"), collapse = ""))
    all_estimates[1, ] = unlist(result0[c(1, 3)])

    result1 = readRDS(paste0(c("MHD_results/EBMR_IPW_", subset_names[2], "_", model_set, "_W_optimal_OR7.RDS"), collapse = ""))
...
boot_result = readRDS(paste0(c("MHD_results/EBMR_IPW_bootstrap_W_optimal_OR7.RDS"), collapse = ""))
