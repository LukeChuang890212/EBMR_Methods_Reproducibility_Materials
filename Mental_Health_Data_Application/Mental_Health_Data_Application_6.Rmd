...
for(model_num in 1:3){
  ...
  for(i in 1:ncol(model_combinations)){
    ...
    for(k in 1:length(health)){
      ...
      save_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", model_set, "_W_optimal_OR6.RDS"), collapse = "")
...
for(k in 1:length(health)){
  ...
  for(xi in xi.vector){
    ...
    save_file = paste0(c("MHD_results/EBMR_IPW_", subset_names[k], "_", 1:3, "_mild", round(xi, 3), "_OR6.RDS"), collapse = "")
