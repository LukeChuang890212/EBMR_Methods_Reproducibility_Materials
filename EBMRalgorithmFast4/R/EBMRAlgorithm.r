...
#'
#' \code{initialize(y_names, ps_specifications, data, W, wt = NULL, bounds = 5)}:
...
EBMRAlgorithmFast4 <- R6Class("EBMRAlgorithmFast4",
                  public = list(
                    ...
                    initialize = function(y_names, ps_specifications, data, W, wt = NULL) {
                      ...
                      # Get optimizer (default: "L-BFGS-B")
                      optimizer <- if (!is.null(ps_specifications$optimizer)) ps_specifications$optimizer else "L-BFGS-B"
