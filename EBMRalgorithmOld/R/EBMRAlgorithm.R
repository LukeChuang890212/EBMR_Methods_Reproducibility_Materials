                   ...
                   public = list(
                     ...
                     initialize = function(y_names, ps_specifications, data, W, wt = NULL) {
                       ...
                       for(j in 1:private$J){
                         ...
                         if(is.null(wt)){
                           self$ps_fit.list[[j]] = self$WangShaoKim2014(formula, h_x_names, inv_link, c(alpha_init, 0))
                         }else{
                           self$ps_fit.list[[j]] = self$WangShaoKim2014(formula, h_x_names, inv_link, c(alpha_init, 0), se.fit = F, wt)
                         }
                       }
