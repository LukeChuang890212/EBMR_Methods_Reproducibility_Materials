...
setting1.A1 = function(n){
  ...
  # Propensity = 1/(1+exp(a0 + 0.2*y - 0.2*u1 - 0.2*y*u1)), no tilt
  # m(x) = 0.2 + 0.3*u1 + 0.6*z1 + 0.6*z2, u2~N(3,2)
  alpha0 = 0.0519
  ...
  m = function(z1, z2, u1, u2) 0.2+0.3*u1+0.6*z1+0.6*z2
  response.prob = function(y, u1, u2) 1/(1+exp(alpha0+0.2*y-0.2*u1-0.2*y*u1))
...
setting1.B1 = function(n){
  ...
  # Propensity = 1/(1+exp(a0+0.2*y-0.2*u1-0.2*y*u1)) * exp(n^(-1/2)*(y+u1+u2))
  # m(x) = 0.2 + 0.3*u1 + 0.6*z1 + 0.6*z2, u2~N(3,2)
  # Intercept depends on n: n=2000 -> 0.1891, n=500 -> 0.3216
  alpha0 = ifelse(n >= 1000, 0.1891, 0.3216)
  z1 = rbinom(n, size = 1, prob = 0.5)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.5)
  u2 = rnorm(n, mean = 3, sd = 2)
  ...
  propensity = 1/(1+exp(alpha0+0.2*y-0.2*u1-0.2*y*u1))*exp(n^(-1/2)*(y+u1+u2))
...
setting1.B2 = function(n){
  ...
  # Propensity = 1/(1+exp(a0+0.2*y-0.2*u1-0.2*y*u1)) * exp(n^(-1/2)*(y+u1+u2))
  # m(x) = 0.2 + 0.3*u1 + 0.6*z1 + 0.6*z2, u2~N(3,2)
  # Intercept depends on n: n=2000 -> -0.5896, n=500 -> -0.3915
  alpha0 = ifelse(n >= 1000, -0.5896, -0.3915)
  z1 = rbinom(n, size = 1, prob = 0.5)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.5)
  u2 = rnorm(n, mean = 3, sd = 2)
...
setting2.A1 = function(n){
  ...
  # Binary y with logistic link, Propensity = 1/(1+exp(a0 + 0.2*y - 0.2*u1 - 0.2*y*u1)), no tilt
  # m(x) = 0.2 + 0.3*u1 + 0.6*z1 + 0.6*z2, u2~N(3,2)
  alpha0 = 0.0407
  z1 = rbinom(n, size = 1, prob = 0.5)
  z2 = rnorm(n, mean = 0, sd = 2)
...
setting2.B1 = function(n){
  ...
  # Propensity = 1/(1+exp(a0+0.2*y-0.2*u1-0.2*y*u1)) * exp(n^(-1/2)*(y+u1+u2))
  # m(x) = 0.2 + 0.3*u1 + 0.6*z1 + 0.6*z2, u2~N(3,2)
  # Intercept depends on n: n=2000 -> 0.1789, n=500 -> 0.3103
  alpha0 = ifelse(n >= 1000, 0.1789, 0.3103)
  z1 = rbinom(n, size = 1, prob = 0.5)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.5)
  u2 = rnorm(n, mean = 3, sd = 2)
...
setting2.B2 = function(n){
  ...
  # Propensity = 1/(1+exp(a0+0.2*y-0.2*u1-0.2*y*u1)) * exp(n^(-1/2)*(y+u1+u2))
  # m(x) = 0.2 + 0.3*u1 + 0.6*z1 + 0.6*z2, u2~N(3,2)
  # Intercept depends on n: n=2000 -> -0.5928, n=500 -> -0.3981
  alpha0 = ifelse(n >= 1000, -0.5928, -0.3981)
  z1 = rbinom(n, size = 1, prob = 0.5)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.5)
  u2 = rnorm(n, mean = 3, sd = 2)
...
setting4.A1 = function(n){
  # Target: ~50% missing rate (response rate ~0.5), correctly specified PS model
  # Binary y with logistic link, Propensity = 1/(1+exp(a0 + 0.15*y - 0.30*u1 + 0.80*u2)), no tilt
  # m(x) = 1 + u1 + u2 + z1 + z2, z1~Bern(0.4), u1~Bern(0.6), u2~N(0,1)
  alpha0 = 0.0672
  z1 = rbinom(n, size = 1, prob = 0.4)
  z2 = rnorm(n, mean = 0, sd = 2)
...
setting4.B1 = function(n){
  # Target: ~50% response rate, with local misspecification via 10x linear tilt
  # Propensity = 1/(1+exp(a0+0.15*y-0.30*u1+0.80*u2)) * exp(10*n^(-1/2)*(y+u1+u2))
  # m(x) = 1 + u1 + u2 + z1 + z2
  # z1~Bern(0.4), u1~Bern(0.6), u2~N(0,1)
  # Intercept depends on n
  alpha0 = ifelse(n >= 1000, 0.5660, 1.0545)
  z1 = rbinom(n, size = 1, prob = 0.4)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.6)
  u2 = rnorm(n, mean = 0, sd = 1)
...
setting4.B2 = function(n){
  # Target: ~70% response rate, with local misspecification via 10x linear tilt
  # Propensity = 1/(1+exp(a0+0.15*y-0.30*u1+0.80*u2)) * exp(10*n^(-1/2)*(y+u1+u2))
  # m(x) = 1 + u1 + u2 + z1 + z2
  # z1~Bern(0.4), u1~Bern(0.6), u2~N(0,1)
  # Intercept depends on n
  alpha0 = ifelse(n >= 1000, -0.1039, 0.5310)
  z1 = rbinom(n, size = 1, prob = 0.4)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.6)
  u2 = rnorm(n, mean = 0, sd = 1)
...
setting14.B1 = function(n){
  ...
  alpha0 = ifelse(n >= 1000, 0.1844, 0.2517)
  z1 = rbinom(n, size = 1, prob = 0.4)
  z2 = rnorm(n, mean = 0, sd = 2)
  u1 = rbinom(n, size = 1, prob = 0.6)
  u2 = rnorm(n, mean = 1, sd = 2)
