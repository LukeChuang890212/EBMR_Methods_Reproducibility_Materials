## Sweep cond for s2.B1 n=2000, M3 only, Fast4 — current DGP (0.2*y -0.8*u1 +0.8*u2).
...
cat(sprintf("\n========= SWEEP (Fast4): s2.B1 n=2000 M3, %d reps =========\n", n_reps))
out_all <- list()
...
saveRDS(out_all, "Simulation_Test/sweep_cnr_s2_miss50_n2000_M3_fast4_results.RDS")
cat("\n========= DONE =========\n")
