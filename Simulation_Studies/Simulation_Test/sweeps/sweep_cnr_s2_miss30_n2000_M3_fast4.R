## Sweep cond for s2.B2 n=2000 (miss30), M3 only, Fast4, current DGP.
## Matches test65 file EBMR_IPW_setting2-miss30-scenario9-3_3_n2000_replicate1000_test65.RDS.
...
cat(sprintf("\n========= SWEEP (Fast4): s2.B2 n=2000 M3 miss30, %d reps =========\n", n_reps))
out_all <- list()
for (optspec in configs_opt) {
  out <- run_one(optspec); res <- out$res
...
saveRDS(out_all, "Simulation_Test/sweep_cnr_s2_miss30_n2000_M3_fast4_results.RDS")
cat("\n========= DONE =========\n")
