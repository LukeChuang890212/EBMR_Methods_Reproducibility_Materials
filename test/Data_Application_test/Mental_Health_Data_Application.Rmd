...
```{r}
all_results = matrix(NA, 16, 2)
all_estimates = matrix(NA, length(health), 2)
k = 1
for(model_num0 in 1:3){
  model_combinations0 = combn(3, model_num0)
  for(i in 1:ncol(model_combinations0)){
    print(c(model_num0, i))
    model_set0 = model_combinations0[, i]
    if(!(1 %in% model_set0)) next
    ...
    for(model_num1 in 1:3){
      model_combinations1 = combn(3, model_num1)
      for(j in 1:ncol(model_combinations1)){
        print(c(model_num0, j))
        model_set1 = model_combinations1[, j]
        if(!(1 %in% model_set1)) next
...
```{r}
boot_se_ipw = boot_CI =  boot_se_ipw.mean = boot_se_ipw.CI = rep(NA, 16)
k = 1
par(mfrow = c(4, 5))
for(model_num0 in 1:3){
  model_combinations0 = combn(3, model_num0)
...
rownames(all_results) = c("$\\hat{\\theta}_{100}^{100}$", "$\\hat{\\theta}_{100}^{110}$", "$\\hat{\\theta}_{100}^{101}$",
                  "$\\hat{\\theta}_{100}^{111}$", "$\\hat{\\theta}_{110}^{100}$", "$\\hat{\\theta}_{110}^{110}$",
                  "$\\hat{\\theta}_{110}^{101}$", "$\\hat{\\theta}_{110}^{111}$", "$\\hat{\\theta}_{101}^{100}$",
                  "$\\hat{\\theta}_{101}^{110}$", "$\\hat{\\theta}_{101}^{101}$", "$\\hat{\\theta}_{101}^{111}$",
                  "$\\hat{\\theta}_{111}^{100}$", "$\\hat{\\theta}_{111}^{110}$", "$\\hat{\\theta}_{111}^{101}$",
                  "$\\hat{\\theta}_{111}^{111}$")
